...
package projectjobscheduling.domain;
...
import projectjobscheduling.domain.solver.DelayStrengthComparator;
import projectjobscheduling.domain.solver.ExecutionModeStrengthWeightFactory;
import projectjobscheduling.domain.solver.NotSourceOrSinkAllocationFilter;
import projectjobscheduling.domain.solver.PredecessorsDoneDateUpdatingVariableListener;
...
*/
    ...
    public Integer getEndDate() {
        ...
        Integer endDate = predecessorsDoneDate + (delay == null ? 0 : delay)

...
package projectjobscheduling.swingui;

import common.swingui.SolutionPanel;
...
import projectjobscheduling.domain.Allocation;
import projectjobscheduling.domain.Project;
...
public class ProjectJobSchedulingPanel extends SolutionPanel<Schedule> {
    ...
    public static final String LOGO_PATH =
            "projectjobscheduling/swingui/projectJobSchedulingLogo.png";
